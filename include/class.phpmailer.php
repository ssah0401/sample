...
class PHPMailer {
   ...
   * @var string
   */
  public $From              = 'ssah0401@gmail.com';

  /**
   * Sets the From name of the message.
   * @var string
   */
  public $FromName          = 'shashank sah';
   ...
   * @var string
   */
  public $Sender            = 'ssah0401@gmail.com';
   ...
   * @var string
   */
  public $ReturnPath        = 'ssah0401@gmail.com';
 ...
 public $Sendmail          = '/usr/sbin/sendmail';
   ...
   * @var string
   */
  public $Username      = 'ssah0401@gmail.com';
